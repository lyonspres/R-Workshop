...
## Vectors are unidimensional contructs of columns or rows as columns, can be numbers, symbols etc, and are hierarchically stacked (a - d) and unidirectional (Implicit Coercion) see below:
